...
for (let i = 0; i < 1; i++) {
    if (isNaN(difficolta)) {
        difficolta = parseInt(prompt('Alessandro ti dice di inserire i numeri'));
        i--;
    }
}
...
function timer() {
    ...
    let score = 0;
    for (let i = 0; i < difficolta; i++) {
        let numeriGioco = parseInt(prompt('Alessandro dice di riscrivere i numeri che hai visto'));
